...
proj_lang = st.text_input("Languages Used (Comma-seperated)")
lead_dev_name = st.text_input("Lead Developer Name")
lead_dev_exp = st.number_input("Lead Developer Excperience (Years)", min_value=0, max_value=50, value=0)
...
if st.button("Get Project"):
    ...
    if project_data:
        ...
        for project in project_data:
            ...
            st.markdown(f"**Lead Developer:**{project['lead_developer']['name']} with {project['lead_developer']['experince']} years of experience")
    else:
